...
function toDomainCampaign(row: PrismaCampaign): Campaign {
  return {
    ...
    heroImageFullBleed: row.heroImageFullBleed,
    ...
    heroCustomColor: row.heroCustomColor,
    heroTextColor: row.heroTextColor,
    heroButtonColor: row.heroButtonColor,
    heroButtonTextColor: row.heroButtonTextColor,
    buyButtonColor: row.buyButtonColor,
    buyButtonTextColor: row.buyButtonTextColor,
    ...
    heroTextScale: row.heroTextScale,
    heroDescriptionOffsetX: row.heroDescriptionOffsetX,
    heroDescriptionOffsetY: row.heroDescriptionOffsetY,
    heroDescriptionScale: row.heroDescriptionScale,
    heroCtaOffsetX: row.heroCtaOffsetX,
    heroCtaOffsetY: row.heroCtaOffsetY,
