    ...
    <>
      ...
      <section className="hero-mobile" style={styles.heroMobile}>
        ...
        <div className="hero-enter" style={styles.heroMobileContent}>
          <h1 style={{ ...styles.h1, fontSize: 32, margin: "0 0 8px" }}>
            Stock in.
            <br />
            Sale live.
          </h1>
          <p style={{ ...styles.heroSub, fontSize: 14, lineHeight: 1.4, margin: 0 }}>The AI-powered platform that turns unsold stock into a complete branded sale — in days, not months.</p>
          <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 14, maxWidth: 220 }}>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  heroMobileImage: { width: "100%", display: "block", aspectRatio: "1080 / 1290", objectFit: "cover", objectPosition: "35% center" },
  heroMobileContent: { position: "absolute", top: 0, left: 0, right: 0, bottom: 0, display: "flex", flexDirection: "column", justifyContent: "flex-start", padding: "9% 24px 0", textAlign: "left" },
