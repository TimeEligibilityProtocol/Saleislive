  ...
  return (
    <>
      ...
      <section className="hero-mobile" style={styles.heroMobile}>
        <img className="hero-kenburns" src="/images/hero-product.png" alt="Products staged for a branded sale generated by saleis.live" style={styles.heroMobileImage} />
        <div className="hero-enter" style={styles.heroMobileContent}>
          <h1 style={{ ...styles.h1, fontSize: 26, margin: "0 0 6px", maxWidth: 200 }}>
            Stock in.
            <br />
            Sale live.
          </h1>
          <p style={{ ...styles.heroSub, fontSize: 12.5, lineHeight: 1.35, margin: 0, maxWidth: 190 }}>The AI-powered platform that turns unsold stock into a complete branded sale — in days, not months.</p>
          <div style={{ display: "flex", flexDirection: "column", gap: 6, marginTop: 12, maxWidth: 170 }}>
            <a href={ADMIN_URL} className="marketing-primary-btn" style={{ ...styles.primaryButton, textAlign: "center", padding: "10px 16px", fontSize: 12.5 }}>
              Get saleis.live
            </a>
            <a href="#demo" className="marketing-secondary-btn" style={{ ...styles.secondaryButton, textAlign: "center", padding: "10px 16px", fontSize: 12.5 }}>
              View demo
            </a>
          </div>
        </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  heroMobileImage: { width: "100%", display: "block", aspectRatio: "1080 / 1290", objectFit: "cover", objectPosition: "85% center" },
  heroMobileContent: {
    position: "absolute",
    top: 0,
    left: 0,
    ...
    padding: "7% 24px 0",
    textAlign: "left",
    background: "linear-gradient(180deg, rgba(245,242,235,0.92) 0%, rgba(245,242,235,0.75) 45%, rgba(245,242,235,0) 65%)",
  },
