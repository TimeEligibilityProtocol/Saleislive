    ...
    <>
      ...
      <section className="hero-mobile" style={styles.heroMobile}>
        ...
        <div className="hero-enter" style={styles.heroMobileContent}>
          <h1 style={{ ...styles.h1, fontSize: 50, margin: "0 0 10px", maxWidth: 230 }}>
            Stock in.
            <br />
            Sale live.
          </h1>
          <p style={{ ...styles.heroSub, fontSize: 14.5, lineHeight: 1.4, margin: 0, maxWidth: 180 }}>The AI-powered platform that turns unsold stock into a complete branded sale — in days, not months.</p>
          <div style={{ display: "flex", flexDirection: "column", gap: 6, marginTop: 14, maxWidth: 120 }}>
            <a href={ADMIN_URL} className="marketing-primary-btn" style={{ ...styles.primaryButton, textAlign: "center", padding: "7px 10px", fontSize: 10.5 }}>
              Get saleis.live
            </a>
            <a href="#demo" className="marketing-secondary-btn" style={{ ...styles.secondaryButton, textAlign: "center", padding: "7px 10px", fontSize: 10.5 }}>
              View demo
            </a>
          </div>
        </div>
